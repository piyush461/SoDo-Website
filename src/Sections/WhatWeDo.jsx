  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-shrink-0 justify-between gap-4 mt-8 max-md:flex-col">
        <div className="thCard md:h-[325px] md:w-1/3 flex flex-col justify-between max-md:gap-14 rounded-2xl p-6 pt-8 font-poppins">
          <h3>
        ...
        <div className="thCard md:h-[325px] md:w-1/3 flex flex-col justify-between max-md:gap-14 rounded-2xl p-5 pt-8 font-poppins">
          <h3>
            {" "}

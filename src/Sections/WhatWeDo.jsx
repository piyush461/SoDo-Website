...
const WhatWeDo = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-shrink-0 justify-between gap-4 mt-8">
        ...
        <div className="thCard h-[325px] w-1/3 flex flex-col justify-between rounded-2xl p-5 pt-8 font-poppins">
          <h3>
            {" "}

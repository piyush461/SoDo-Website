          ...
          <div className="h-[100%] w-[100%] flex flex-col gap-6">
            <div className="flex flex-wrap gap-8">
              <div className="h-fit w-[44%]">
                <label className="block text-lg ml-4">Name</label>
                <input
                  name="name"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  className="border outline-[#0B99FF] my-2 py-[17px] placeholder:text-[#B7B7B7] px-4 w-[100%] text-sm font-normal rounded-[16px]"
                  type="text"
              ...
              <div className="h-fit w-[44%]">
                ...
                <input
                  ...
                  className="border outline-[#0B99FF] my-2 py-[17px] px-4 placeholder:text-[#B7B7B7] w-[100%] text-sm font-normal rounded-[16px]"
                  type="email"
              ...
              <div className="h-fit w-[44%]">
                ...
                <input
                  ...
                  className="border outline-[#0B99FF] my-2 py-[17px] w-[100%] placeholder:text-[#B7B7B7] px-4 text-sm font-normal rounded-[16px]"
                  type="tel"

    ...
    <div className="container flex flex-col h-[100svh] overflow-hidden mx-auto p-6 max-w-4xl">
      ...
      <div className="flex-1 h-full overflow-y-scroll pr-5">
        ...
        <p className="text-gray-700 mt-2">
          We at <strong>SoDo</strong> value your trust and are committed to
          protecting your privacy. This Privacy Policy explains how we collect,
          use, and safeguard your information when you visit our website or
          engage with our services. By using our website, you acknowledge and
        ...
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Client Information:</strong> Your name, email address, phone
            number, company details, and hiring requirements when you inquire
            about our services.
          </li>
          <li>
            <strong>Non-Personal Information:</strong> Your browser type, IP
            address, device information, pages visited, and browsing patterns
        ...
        <ul className="list-disc list-inside text-gray-700 mt-2">
          ...
          <li>
            Providing support, responding to inquiries, and improving client
            service and relations.
          </li>
          <li>
            Sending relevant updates, insights, and industry trends (with the
            option to opt out at any time).
          </li>
          <li>
            Enhancing website security, functionality, and user experience.
          </li>
        ...
        <p className="text-gray-700 mt-2">
          We respect your privacy and do not sell or trade your information.
          However, we may share data with:
        </p>
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Recruitment consultants and candidates:</strong> To execute
            recruitment and hiring processes.
          </li>
          <li>
            <strong>Service Providers:</strong> Who help us with website
        ...
        <p className="text-gray-700 mt-2">
          ...
          unauthorized access. However, as no system is completely secure, we
          encourage you to take precautions in protecting your personal data.
        </p>
        ...
        <p className="text-gray-700 mt-2">
          ...
          experience and track performance. You have control over your cookie
